...
from .models import Message, JobData, Pricing, Staff, BeforAfterImg, ServiceDetail, BlogDetailsView, ServiceCat
...
@admin.register(ServiceCat)
class ServiceCat(admin.ModelAdmin):
